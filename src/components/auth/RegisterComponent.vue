  ...
  <section class="text-gray-600 body-font relative">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-12">
        <h1
          class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900 title"
        >
      ...
      <form @click.prevent="" class="lg:w-1/2 md:w-2/3 mx-auto">
        ...
        <div class="flex flex-wrap -m-2">
          <div class="p-2 w-full">
            <div class="relative">
              <label for="name" class="text-sm font-bold text-gray-500 tracking-wide"
                >Nombre</label
              >
              <input
                v-model="data.name"
          ...
          <div class="p-2 w-full">
            <div class="relative">
              <label for="passwordTwo" class="text-sm font-bold text-gray-500 tracking-wide"
...
export default {
  ...
  setup() {
    ...
    const sendData = async () => {
      ...
      data.password = ""
      data.password2 = ""
      if(userRegister) NotifyComponent.login(
